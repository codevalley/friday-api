...
def test_document_validation():
    ...
    # Test empty name
    with pytest.raises(DocumentValidationError, match="name cannot be empty"):
        DocumentData(
            name="",
            storage_url="/test/path",
            mime_type="text/plain",
    ...
    with pytest.raises(DocumentValidationError, match="storage_url cannot be empty"):
        DocumentData(
            name="Test Document",
            storage_url="",
            mime_type="text/plain",
    ...
    # Test negative size
    with pytest.raises(DocumentValidationError, match="size_bytes must be positive"):
        DocumentData(
            name="Test Document",
            storage_url="/test/path",
            mime_type="text/plain",
...
def test_unique_name_validation():
    ...
    with pytest.raises(DocumentValidationError, match="unique_name must be alphanumeric"):
        DocumentData(
            name="Test Document",
            storage_url="/test/path",
            mime_type="text/plain",
...
def test_status_transitions():
    ...
    with pytest.raises(DocumentValidationError, match="Invalid status transition"):
...
def test_public_access():
    ...
    with pytest.raises(DocumentValidationError, match="Public documents must have a unique name"):
        DocumentData(
            name="Test Document",
            storage_url="/test/path",
            mime_type="text/plain",
...
def test_metadata_validation():
    ...
    with pytest.raises(DocumentValidationError, match="metadata must be a dictionary"):
        DocumentData(
            name="Test Document",
            storage_url="/test/path",
            mime_type="text/plain",
